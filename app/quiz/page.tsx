  ...
  const calculateResult = (allAnswers: QuizAnswer[]): QuizResult => {
    ...
    for (const answer of allAnswers) {
      ...
      if (answer.signal.trait)
        traitCounts[answer.signal.trait] =
          (traitCounts[answer.signal.trait] || 0) + 1;
        ...
        <section className="relative min-h-[50vh] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 py-16 md:py-28">
            ...
            >
              ...
              >
                Six questions. Three universities worth exploring. Takes two
                minutes.
              </motion.p>
            </motion.div>
          </div>
                  ...
                  {Array.from({ length: QUIZ_QUESTIONS.length }).map((_, i) => (
                    <div
                      ...
                      style={{
                        ...
                        background:
                          i <= currentQuestion ? COLORS.primary : "#e0e0e0",
                      }}
                    />
                  ))}
                </div>
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12">
              ...
              >
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {QUIZ_PROFILES[result.profile].universities.map(
                      (uni, idx) => (
                        <motion.div
                          key={idx}
                ...
                <div className="text-center space-y-6">
                  ...
                  <p className="text-white/50 italic text-base">
                    &ldquo;These are starting points, not answers. The right
                    university for your child is a conversation.&rdquo;
                  </p>
                </div>
              </motion.div>
            </div>

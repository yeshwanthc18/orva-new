        ...
        <section className="relative min-h-[60vh] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 py-20 md:py-32">
            ...
            >
              ...
              >
                Every child&apos;s journey with Orva is different. What they
                share is this: the right decision, made with confidence.
              </motion.p>
            </motion.div>
          </div>
        </section>
        ...
        >
          <ScrollRevealStrip direction="left">
            <span className="text-[clamp(14px,1.5vw,18px)] font-bold text-white/8 uppercase tracking-[0.2em]">
              Success &bull; Confidence &bull; Growth &bull; Discovery &bull;
              Achievement &bull; Success &bull; Confidence &bull; Growth &bull;
              Discovery &bull; Achievement &bull; Success &bull; Confidence
              &bull; Growth &bull; Discovery &bull; Achievement
            </span>
          </ScrollRevealStrip>
        </div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 text-center">
            ...
            >
              ...
              <blockquote className="text-2xl md:text-4xl font-light text-white mb-8 leading-relaxed">
                &ldquo;We are ambitious for every child we advise. But what
                drives us is simple: we want them to thrive — at the
                world&apos;s best universities, and in the life that
                follows.&rdquo;
              </blockquote>
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            >
              ...
              >
                Every ambitious student deserves guidance from advisors who
                understand not just universities, but the career and life that
                follows.
              </p>
      ...
      >
        ...
        <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-white/10 backdrop-blur-md border border-white/20">
          <p className="text-white text-sm font-bold">
            {story.name} &middot; {story.university}
          </p>

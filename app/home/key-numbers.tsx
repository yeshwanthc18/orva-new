        ...
        <div className="border border-black/10">
          <div className="grid lg:grid-cols-3">
            ...
            <motion.div
              ...
              className="lg:col-span-1 p-10 lg:p-14 border-b bg-[#F75105] lg:border-b-0 lg:border-r border-black/10 flex flex-col justify-between"
            >
              <div>
                ...
                >
                  Every statistic reflects a student, a family, and a future
                  transformed through expert university guidance.
                </p>
              </div>

              <div className="hidden lg:block mt-16 pt-8 border-t border-white/40">
                <p

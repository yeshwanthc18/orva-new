...
export default function WhyChooseSection({ differentiators }: WhyChooseSectionProps) {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight" style={{ color: COLORS.textDark }}>
            Why Families Choose ORVA
          </h2>
          <p className="text-lg" style={{ color: COLORS.textLight }}>
            What sets us apart in the world of university guidance
          </p>
        </motion.div>
